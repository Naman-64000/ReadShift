...
async function main() {
  console.log("🚀 Starting quality score recalculation for 'gemini 3' passages...");

  // Fetch passages belonging to gemini 3
  ...
  console.log(`Found ${passages.length} passages to process under 'gemini 3'.`);
